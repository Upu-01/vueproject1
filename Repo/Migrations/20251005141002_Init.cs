    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductProductGroup", x => new { x.GroupsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_ProductProductGroup_ProductGroup_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "ProductGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductProductGroup_Product_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleArticleGroup", x => new { x.ArticlesId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_ArticleArticleGroup_ArticleGroup_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "ArticleGroup",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ArticleArticleGroup_Article_ArticlesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleArticleGroup_GroupsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductProductGroup_ProductsId",
