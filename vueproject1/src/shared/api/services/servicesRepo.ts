...
export class TestServicesRepo implements IServicesRepository {
  private articles: Artycle[] = [...testServices];
...
export class ApiServicesRepo implements IServicesRepository {
...
export function createServicesRepository(useApi: boolean): IServicesRepository {
  return useApi ? new ApiServicesRepo() : new TestServicesRepo();
}