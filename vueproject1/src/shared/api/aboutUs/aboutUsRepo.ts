...
import { testAboutUs } from "./aboutUs";
...
export class TestAboutUsRepo implements IAboutUsRepository {
  private articles: Artycle[] = [...testAboutUs];
...
export class ApiAboutUsRepo implements IAboutUsRepository {
...
export function createAboutUsRepository(useApi: boolean): IAboutUsRepository {
  return useApi ? new ApiAboutUsRepo() : new TestAboutUsRepo();
}