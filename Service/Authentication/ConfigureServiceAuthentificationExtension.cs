...
namespace Service.Authentication
{
    ...
    public class ClaimsTransformer : IClaimsTransformation
    {
        public Task<ClaimsPrincipal> TransformAsync(ClaimsPrincipal principal)
        {
            ...
            if (claimsIdentity.IsAuthenticated && claimsIdentity.HasClaim((claim) => claim.Type == "user_realm_roles"))
            {
                //TODO add claims
                foreach (var role in claimsIdentity.Claims.Where(c=>c.Type == "user_realm_roles").ToList())
                {
        ...
        public static void ConfigureJWT(this IServiceCollection services, bool IsDevelopment, string publicKeyJWT)
        {
            ...
            AuthenticationBuilder.AddJwtBearer(o =>
            {
                ...
                o.TokenValidationParameters = new TokenValidationParameters
                {
                    ...
                    ValidateIssuer = true,
                    ValidIssuers = new[] { "https://auth.pirs.online/realms/master" },
